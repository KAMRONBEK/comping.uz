...
const BuildItem = (props: propsType) => {
	return (
		<div className=" w-full flex  flex-col items-center ">
			...
			>
				<div
					style={{ background: 'linear-gradient(251deg, #C0B7E8 12.87%, #8176AF 89.33%) ' }}
					className=" w-[159px] h-[159px] rounded-[50%] flex justify-center items-center "
				>
					<p className=" text-[64px] text-[#343045] font-bold">{props.number}</p>
				</div>
			</div>
			<div className="flex  items-center  w-[250px] ">
				<ArrowLeftIcon />
				<p className=" text-[24px] text-[#fff]">3D Conception & Design</p>
			</div>
		</div>
	);
};
