  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'small-headline-6': ['16px', {
          lineHeight: '24px',
          fontWeight: '700',
        }],
        'small-headline-2': ['28px', {
          lineHeight: '32px',
          fontWeight: '700',
        }],
        'small-headline-4': ['40px', {
          lineHeight: '48px',
          fontWeight: '700',
        }],
        'small-body-16': ['12px', {
